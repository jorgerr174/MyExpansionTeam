...
{
    public class ProspectDto : AthleteDto
    {
        ...
        public ProspectDto() : base() { }

        public ProspectDto(int Id, string Player, int Height, int Weight, string College, string Position,
            ...
            : base(Id, Player, Height, Weight, College, Position)
        {
            this.Year = Year;
